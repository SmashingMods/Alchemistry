...
public class CombinerBlockEntity extends AbstractAlchemistryBlockEntity  {
    ...
    public static void tick(Level pLevel, BlockPos pPos, BlockState pState, CombinerBlockEntity pBlockEntity) {
