# Alchemistry 1.21.4-2.4.7 RELEASE

Requires ChemLib and AlchemyLib for this version.

Changes:
- Updated to Minecraft 1.21.4 / NeoForge. First Alchemistry release for 1.21.4.
...
- Fixed the compactor having no item model when held or in the inventory.
