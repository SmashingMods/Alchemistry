...
//
//import static com.smashingmods.alchemistry.api.blockentity.PowerStatus.*;
//
...
//        super(BlockEntityRegistry.FISSION_CONTOLLER_BE.get(), pos, state);
...
//        if (state.getBlock() != BlockRegistry.FISSION_CONTROLLER_BLOCK.get()) return;
...
//        return this.level.getBlockState(pos).getBlock() == BlockRegistry.FISSION_CASING_BLOCK.get();
//    }
//
//    private boolean containsCore(BlockPos pos) {
//        return this.level.getBlockState(pos).getBlock() == BlockRegistry.FISSION_CORE_BLOCK.get();
//    }
//
//    private boolean containsFissionPart(BlockPos pos) {
//        Block block = this.level.getBlockState(pos).getBlock();
//        return block == BlockRegistry.FISSION_CASING_BLOCK.get()
//                || block == BlockRegistry.FISSION_CORE_BLOCK.get()
//                || block == BlockRegistry.FISSION_CONTROLLER_BLOCK.get();
//    }
//
