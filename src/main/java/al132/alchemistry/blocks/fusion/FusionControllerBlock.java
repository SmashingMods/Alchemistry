...
public class FusionControllerBlock extends BaseTileBlock {
    ...
    public FusionControllerBlock(){
        super("fusion_controller", FusionTile::new, Block.Properties.create(Material.IRON));
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent(I18n.format("tooltip.alchemistry.energy_requirement", Config.FUSION_ENERGY_PER_TICK.get())));
    }
}
