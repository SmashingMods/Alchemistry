...
public class FusionMultiblockEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        pageText("1x Fusion Chamber Controller\\3x Fusion Core\\1x Reactor Energy Input\\1x Reactor Item Input\\1x Reactor Item Output\\62x Reactor Casing\\36x Reactor Glass");
