...
- Combiner recipe layouts in JEI and the recipe selector now follow the recipe's chemical-formula order, so some ingredient arrangements may look different; what each recipe crafts and costs is unchanged.
