...
public class FissionControllerBlockEntity extends AbstractAlchemistryBlockEntity {
    ...
    public static void tick(Level pLevel, BlockPos pPos, BlockState pState, FissionControllerBlockEntity pBlockEntity) {
