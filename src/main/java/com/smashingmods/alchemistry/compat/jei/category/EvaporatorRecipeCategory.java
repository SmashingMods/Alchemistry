...
import com.smashingmods.alchemistry.blocks.evaporator.EvaporatorRecipe;
...
public class EvaporatorRecipeCategory implements IRecipeCategory<EvaporatorRecipe> {
    ...
    public IDrawable getIcon() {
        return guiHelper.createDrawableIngredient(new ItemStack(Registry.EVAPORATOR_BLOCK.get()));
    }
