...
public class AtomizerEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        pageText("The Atomizer is a powered machine that is used to convert fluids into their equivalent Alchemistry elements or compounds.\\\\*From Professor Warren's notes: Liquids are the simplest things to break down. The mere use of pistons to force them out of cauldrons turns them into easily stored atomic phials.*");
