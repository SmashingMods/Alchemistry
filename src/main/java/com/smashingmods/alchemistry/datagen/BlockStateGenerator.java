...
public class BlockStateGenerator extends BlockStateProvider {
    ...
    private void registerSimpleBlockWithRenderType(DeferredBlock<? extends Block> pBlock, String pRenderType) {
    ...
    private void registerAxisBlock(DeferredBlock<? extends RotatedPillarBlock> pBlock) {
        axisBlock(pBlock.get());
        registerBlockItemModel(pBlock);
    }

    private void registerBlockItemModel(DeferredBlock<? extends Block> pBlock) {
        itemModels().withExistingParent(pBlock.getId().getPath(), modLoc(String.format("block/%s", pBlock.getId().getPath())));
    }

    private void registerMachineModel(DeferredBlock<? extends Block> pBlock, ModelFile pModelFile) {
    ...
    private void registerControllerModel(DeferredBlock<? extends Block> pBlock) {
    ...
    private void registerFaceBlock(DeferredBlock<? extends Block> pBlock, ResourceLocation pFace, ResourceLocation pSide) {
    ...
    private void registerPoweredFaceBlock(DeferredBlock<? extends Block> pBlock, ResourceLocation pFace, ResourceLocation pSide) {
        String path = pBlock.getId().getPath();
