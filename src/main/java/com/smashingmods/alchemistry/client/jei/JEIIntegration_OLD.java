...
//import com.smashingmods.alchemistry.common.recipe.atomizer.AtomizerRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.atomizer.AtomizerScreen;
//import com.smashingmods.alchemistry.common.recipe.combiner.CombinerRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.combiner.CombinerScreen;
//import com.smashingmods.alchemistry.common.block.oldblocks.dissolver.DissolverContainer;
//import com.smashingmods.alchemistry.common.recipe.dissolver.DissolverRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.dissolver.DissolverScreen;
//import com.smashingmods.alchemistry.common.recipe.evaporator.EvaporatorRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.evaporator.EvaporatorScreen;
//import com.smashingmods.alchemistry.common.block.oldblocks.fission.FissionContainer;
//import com.smashingmods.alchemistry.common.recipe.fission.FissionRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.fission.FissionScreen;
//import com.smashingmods.alchemistry.common.block.oldblocks.liquifier.LiquifierContainer;
//import com.smashingmods.alchemistry.common.recipe.liquifier.LiquifierRegistry;
//import com.smashingmods.alchemistry.common.block.oldblocks.liquifier.LiquifierScreen;
...
//
//@JeiPlugin
//public class JEIIntegration_OLD implements IModPlugin {
//
...
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.ATOMIZER_BLOCK.get()), ATOMIZER_RESOURCE);
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.COMBINER_BLOCK.get()), COMBINER_RESOURCE);
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.DISSOLVER_BLOCK.get()), DISSOLVER_RESOURCE);
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.EVAPORATOR_BLOCK.get()), EVAPORATOR_RESOURCE);
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.FISSION_CONTROLLER_BLOCK.get()), FISSION_RESOURCE);
//        reg.addRecipeCatalyst(new ItemStack(BlockRegistry.LIQUIFIER_BLOCK.get()), LIQUIFIER_RESOURCE);
//    }
//
//    @Override
