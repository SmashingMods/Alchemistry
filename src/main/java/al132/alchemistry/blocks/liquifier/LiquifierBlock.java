...
public class LiquifierBlock extends BaseTileBlock {
    ...
    public LiquifierBlock(){
        super("liquifier", LiquifierTile::new, Block.Properties.create(Material.IRON));
    }
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent(I18n.format("tooltip.alchemistry.energy_requirement", Config.LIQUIFIER_ENERGY_PER_TICK.get())));
    }
}
