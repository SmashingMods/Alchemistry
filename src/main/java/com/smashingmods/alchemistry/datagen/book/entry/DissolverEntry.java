...
public class DissolverEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        pageText("The Chemical Dissolver is a powered machine, and it, along with the Chemical Combiner are the most essential machines in Alchemistry. The Chemical Dissolver takes inputs and breaks them down into different chemical elements and compounds.\\\\*From Professor Warren's notes: I've been experimenting with the properties of magma, as a less volatile form of Lava. While Lava will destroy most things, it turns out that I can use magma to more precisely break down materials into their components. Some components are more firmly bonded, and require an additional pass or two to be completely broken down.*");
