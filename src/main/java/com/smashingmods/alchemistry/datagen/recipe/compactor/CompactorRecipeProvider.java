...
public class CompactorRecipeProvider {
    ...
    private void register() {
        ...
        ItemRegistry.getChemicalItemByNameAndType("graphite", ChemicalItemType.COMPOUND).ifPresent(graphite -> compactor(new ItemStack(graphite, 16), Items.DIAMOND));
    ...
    public void compactor(ItemStack pInput, ItemStack pOutput) {
        compactor(new IngredientStack(pInput), pOutput, Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(pOutput.getItem())));
    }
    ...
    public void compactor(ItemLike pInput, ItemLike pOutput) {
        compactor(new IngredientStack(pInput), new ItemStack(pOutput), Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(pOutput.asItem())));
    }
    ...
    @SuppressWarnings("unused")
    public void compactor(String pInputTag, ItemStack pOutput) {
        TagKey<Item> tagKey = TagKey.create(Registries.ITEM, ResourceLocation.parse(pInputTag));
        compactor(new IngredientStack(Ingredient.of(tagKey)), pOutput, Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(pOutput.getItem())));
    }

    @SuppressWarnings("unused")
    public void compactor(String pInputTag, int pCount, ItemStack pOutput) {
        TagKey<Item> tagKey = TagKey.create(Registries.ITEM, ResourceLocation.parse(pInputTag));
    ...
    public void compactor(IngredientStack pInput, ItemStack pOutput, ResourceLocation pRecipeId) {
        ResourceLocation fullId = ResourceLocation.fromNamespaceAndPath(Alchemistry.MODID, String.format("compactor/%s", pRecipeId.getPath()));
