//package com.smashingmods.alchemistry.common.block.oldblocks.combiner;
//
...
//                press -> {
//                    AlchemistryPacketHandler.INSTANCE.sendToServer(new CombinerButtonPacket(this.blockEntity.getBlockPos(), true, false));
...
//                    AlchemistryPacketHandler.INSTANCE.sendToServer(new CombinerButtonPacket(this.blockEntity.getBlockPos(), false, true));
//                });
