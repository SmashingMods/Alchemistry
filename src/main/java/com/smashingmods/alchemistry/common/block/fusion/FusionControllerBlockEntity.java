...
public class FusionControllerBlockEntity extends AbstractAlchemistryBlockEntity {
    ...
    public static void tick(Level pLevel, BlockPos pPos, BlockState pState, FusionControllerBlockEntity pBlockEntity) {
